        ...
        <div class="row">
            <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-white">
                    <div class="inner">
                        <h3>{{ number_format($candidateCount) }}</h3>
            ...
            <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-white">
                    <div class="inner">
                        <h3>{{ number_format($applicationCount) }}</h3>
            ...
            <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-white">
                    ...
                    <a href="#" class="small-box-footer"><i class="fas fa-plus"></i> Add Category</a>
                </div>
            </div>
            <!-- ./col -->
        </div>
